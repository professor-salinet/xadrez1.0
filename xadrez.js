...
var linhaDestino = [];
var colunaDestino = [];
const dirPecas = "./pecas/";
const dirQuadrantes = "./quadrantes/";
        ...
        if (elementoDestino.tagName == "IMG" || elementoDestino.tagName == "img") {
            ...
            if (elementoDestino.tagName == "DIV" || elementoDestino.tagName == "div") {
                if (elementoDestino.innerHTML == "") {
                    ...
                    console.error("Ops! Não é possível realizar este movimento, pois o quadrante " + elementoDestino.id + " já está ocupado por: " + elementoDestino.id);
                }
            }
        }
        pecaClicada = null;
